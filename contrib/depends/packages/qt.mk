...
$(package)_patches=fix_qt_pkgconfig.patch fix_configure_mac.patch fix_no_printer.patch fix_rcc_determinism.patch fix_riscv64_arch.patch xkb-default.patch no-xlib.patch fix_android_qmake_conf.patch fix_android_jni_static.patch
...
define $(package)_preprocess_cmds
  ...
  patch -p1 < $($(package)_patch_dir)/no-xlib.patch && \
  patch -p1 < $($(package)_patch_dir)/fix_android_qmake_conf.patch && \
  patch -p1 < $($(package)_patch_dir)/fix_android_jni_static.patch && \

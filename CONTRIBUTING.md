...
The "Sumokoin Maintainer Team" is defined in this document as the following users:
- quangvu3
...
- Users SHALL NOT log feature requests, ideas, or suggestions unrelated to Sumokoin code or Sumokoin's dependency code or Sumokoin's potential/future dependency code or research which successfully implements Sumokoin.
...
- Maintainers SHOULD NOT merge their own patches except in exceptional cases, such as non-responsiveness from other Maintainers for an extended period (more than 30 days) or unless urgent as defined by the Sumokoin Maintainers Team.
...
- Maintainers MUST NOT merge pull requests in less than 168 hours (1 week) unless deemed urgent by at least 2 people from the Sumokoin Maintainer Team.
